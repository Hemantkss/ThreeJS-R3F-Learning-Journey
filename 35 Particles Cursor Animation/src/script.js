...
const handTexture = textureLoader.load('./picture-2.png')
const helmetTexture = textureLoader.load('./picture-3.png')
const avtarTexture = textureLoader.load('./picture-4.png')
const model1 = textureLoader.load('./model1.jpeg')
const model2 = textureLoader.load('./model2.jpeg')
