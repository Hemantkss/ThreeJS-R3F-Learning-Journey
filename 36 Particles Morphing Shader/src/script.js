...
debugObject.clearColor = "#160920";  gui.addColor(debugObject, "clearColor").onChange(() => {
...
gltfLoader.load("./models.glb", (gltf) => {
  ...
  gui.add(particles, 'morph0').name('Model 1')
  gui.add(particles, 'morph1').name('Model 2')
  gui.add(particles, 'morph2').name('Model 3')
  gui.add(particles, 'morph3').name('Model 4')
